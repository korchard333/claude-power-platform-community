...
> ⚠️ Use solution-specific names for dashboards (e.g., "Contoso Operations Dashboard" not "Operations Dashboard"). Idempotent checks by name can accidentally match a dashboard from another solution and bind the wrong one to your app module. Always scope name checks to solution components.
